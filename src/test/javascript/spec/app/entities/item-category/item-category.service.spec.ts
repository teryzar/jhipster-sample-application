    ...
    describe('ItemCategory Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/item-categories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ItemCategory', () => {
                service.create(new ItemCategory(null)).subscribe(received => {
            ...
            it('should update a ItemCategory', () => {
                service.update(new ItemCategory(123)).subscribe(received => {
            ...
            it('should return a ItemCategory', () => {
            ...
            it('should return a list of ItemCategory', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ItemCategory(123)]);
            });
