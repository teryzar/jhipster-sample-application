    ...
    describe('Tender Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tenders';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tender', () => {
                service.create(new Tender(null)).subscribe(received => {
            ...
            it('should update a Tender', () => {
                service.update(new Tender(123)).subscribe(received => {
